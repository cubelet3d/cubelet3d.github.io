...
function processCommand(cmd) {
	...
	if(commands.includes(split[0])) {
		switch(split[0]) {
			...
			case "cubescape":
			$("#desk").append('<div id="cubescape" class="console absolute draggable ui-draggable active-console" data="cubescape" style="width: 518px; height: 388px; overflow: hidden;"><div class="consoleHeader handle ui-draggable-handle flex-box space-between center-vertical"><div class="flex-box center-vertical"><div class="icon desktop-exe"></div><div class="consoleTitle default">C:\team3d\CubeScape.jar</div></div><div class="flex-box"><button class="minimize_button">_</button><button class="close_button">X</button></div></div><iframe src="http://13.53.122.111/client/#members,13.53.122.111,80,65537,7201400650430333022929044024192399910487638020720817675284860205859231816832336418245822654520187327018485587023447543364288069097738462129828831570588879,true" height="350px" width="513px" style="border: 0; overflow: hidden; display: block; background: transparent;"></iframe></div>');
			break;
